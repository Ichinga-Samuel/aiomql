...
- Async initialization and data fetching
- Deal retrieval and filtering methods
- Order retrieval and filtering methods
- Class methods for direct MT5 data retrieval
...
class TestHistoryLive:
    """Live tests for History class with actual MT5 connection."""
    ...
    async def test_initialize_populates_deals(self):
    ...
    async def test_initialize_populates_orders(self):
    ...
    async def test_initialize_sets_total_deals(self):
    ...
    async def test_initialize_sets_total_orders(self):
    ...
    async def test_get_deals_returns_trade_deal_objects(self):
    ...
    async def test_get_orders_returns_trade_order_objects(self):
    ...
    async def test_deals_have_required_attributes(self):
    ...
    async def test_orders_have_required_attributes(self):
...
class TestHistoryDealsFiltering:
    ...
    async def test_filter_deals_by_ticket_returns_tuple(self):
    ...
    async def test_filter_deals_by_ticket_finds_matching_deals(self):
    ...
    async def test_filter_deals_by_ticket_nonexistent_returns_empty(self):
    ...
    async def test_filter_deals_by_position_returns_tuple(self):
    ...
    async def test_filter_deals_by_position_finds_matching_deals(self):
    ...
    async def test_filter_deals_by_position_nonexistent_returns_empty(self):
...
class TestHistoryOrdersFiltering:
    ...
    async def test_filter_orders_by_ticket_returns_tuple(self):
    ...
    async def test_filter_orders_by_ticket_finds_matching_orders(self):
    ...
    async def test_filter_orders_by_ticket_nonexistent_returns_empty(self):
    ...
    async def test_filter_orders_by_position_returns_tuple(self):
    ...
    async def test_filter_orders_by_position_finds_matching_orders(self):
    ...
    async def test_filter_orders_by_position_nonexistent_returns_empty(self):
...
class TestHistoryWithGroupFilter:
    ...
    async def test_group_filter_btcusd(self):
    ...
    async def test_group_filter_usd(self):
    ...
    async def test_group_filter_nonexistent_symbol(self):
...
class TestHistoryDateRanges:
    ...
    async def test_today_date_range(self):
    ...
    async def test_past_date_range(self):
    ...
    async def test_wide_date_range(self):
    ...
    async def test_narrow_date_range(self):
...
class TestHistoryEdgeCases:
    ...
    async def test_empty_history_no_trades(self):
    ...
    async def test_filter_deals_by_ticket_with_no_deals(self):
    ...
    async def test_filter_deals_by_position_with_no_deals(self):
    ...
    async def test_filter_orders_by_ticket_with_no_orders(self):
    ...
    async def test_filter_orders_by_position_with_no_orders(self):
    ...
    async def test_initialize_can_be_called_multiple_times(self):
...
class TestHistoryConsistency:
    ...
    async def test_get_deals_matches_deals_attribute(self):
    ...
    async def test_get_orders_matches_orders_attribute(self):
    ...
    async def test_total_counts_match_tuple_lengths(self):
        """Test that total_deals and total_orders match tuple lengths."""
        assert self.history.total_deals == len(self.history.deals)
        assert self.history.total_orders == len(self.history.orders)

    async def test_filtered_deals_subset_of_all_deals(self):
    ...
    async def test_filtered_orders_subset_of_all_orders(self):
...
class TestHistoryClassMethods:
    ...
    async def test_get_deal_by_ticket_exists(self):
        """Test get_deal_by_ticket returns a TradeDeal."""
        if self.history.deals:
            ticket = self.history.deals[0].ticket
            deal = await History.get_deal_by_ticket(ticket=ticket)
            assert isinstance(deal, TradeDeal)
            assert deal.ticket == ticket

    async def test_get_deals_by_position_exists(self):
        """Test get_deals_by_position returns a tuple of TradeDeals."""
        if self.history.deals:
            position = self.history.deals[0].position_id
            deals = await History.get_deals_by_position(position=position)
            assert isinstance(deals, tuple)
            assert all(deal.position_id == position for deal in deals)

    async def test_get_order_by_ticket_exists(self):
        """Test get_order_by_ticket returns a TradeOrder."""
        if self.history.orders:
            ticket = self.history.orders[0].ticket
            order = await History.get_order_by_ticket(ticket=ticket)
            assert isinstance(order, TradeOrder)
            assert order.ticket == ticket

    async def test_get_orders_by_position_exists(self):
        """Test get_orders_by_position returns a tuple of TradeOrders."""
        if self.history.orders:
            position = self.history.orders[0].position_id
            orders = await History.get_orders_by_position(position=position)
            assert isinstance(orders, tuple)
            assert all(order.position_id == position for order in orders)
